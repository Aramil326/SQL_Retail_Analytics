DROP FUNCTION IF EXISTS get_reward;
CREATE OR REPLACE FUNCTION get_reward(max_churn_index NUMERIC,
...
DROP FUNCTION IF EXISTS get_personal_offer_growth_of_the_average_check(average_check_calculation_method INT,
                                                                       ...
                                                                       max_share_of_transactions_with_a_discount INT,
                                                                       allowable_share_of_margin INT);
CREATE OR REPLACE FUNCTION get_personal_offer_growth_of_the_average_check(
