DROP FUNCTION IF EXISTS get_margin(method VARCHAR, count INT) CASCADE;
CREATE OR REPLACE FUNCTION get_margin(method VARCHAR DEFAULT 'default ', count INT DEFAULT 0)
    RETURNS TABLE
            (
                Customer_ID  INT,
                Group_ID     INT,
